    ...
    public async Task RunAsync()
        {
            ...
            udp.Client.Bind(new IPEndPoint(_bindAddress, MdnsPort));
        ...
        while (!cts.Token.IsCancellationRequested)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            byte[] response = BuildMdnsAResponse(name, _advertisedAddress);
